...
{
    public partial class FormAltaProdMenuSuperv : Form
    {
        private ProductoNegocio productoNegocio = new ProductoNegocio();
        private FormMenuSupervisor FormMenuSupervisor;
        ...
        public FormAltaProdMenuSuperv(FormMenuSupervisor formMenuSupervisor)
        {
            InitializeComponent();
        ...
        {
            this.Hide();
            FormMenuSupervisor.AbrirFormulario(new FormListoProductoMenuSuper(FormMenuSupervisor));
        }
        ...
        private void FormAltaProdMenuSuperv_Load(object sender, EventArgs e)
        {
