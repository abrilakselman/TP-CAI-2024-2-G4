...
{
    public partial class FormEditarProdMenuSuperv : Form
    {
        ...
        public FormEditarProdMenuSuperv(FormMenuSupervisor formMenuSupervisor, Guid idproducto, string nombre, string stock, string precio)
        {
            InitializeComponent();
